...
4) use { this.props.activeSwitch === 1 ? view1 : view2 }
...
export default class SwitchButton extends Component {
    ...
    componentWillReceiveProps(props) {
        if (props.defaultIndex != this.props.defaultIndex) {
            this.setState({isCalled: true})
            console.log('HIIIIIIIII :', this.props.defaultIndex)
            this.setState({ activeSwitch: this.props.defaultIndex });
    ...
    _switchThump(direction) {
        ...
        if (this.props.activeSwitch === 1) {
            this.setState({ activeSwitch: 2 }, () => onValueChange(2));
            ...
            this.setState({ activeSwitch: 1 }, () => onValueChange(1));
            Animated.timing(
                this.state.offsetX,
                {
                    toValue: 0,
                ...
                <TouchableOpacity activeOpacity={1} onPress={() => { this._switchThump(this.props.switchdirection || this.state.direction) }}>
                    ...
                    >
                        <View style={[{ flexDirection: this._switchDirection(this.props.switchdirection || this.state.direction) }]} >
                            ...
                            >
                                <Text style={[this.props.textStyle, this.props.activeSwitch === 1 ? { color: this.props.activeFontColor || "#fff" } : { color: this.props.fontColor || "#b1b1b1" }]}>
                                    {this.props.text1 || 'ON'}
                                </Text>
                            </View>
                            ...
                            >
                                <Text style={[this.props.textStyle, this.props.activeSwitch === 2 ? { color: this.props.activeFontColor || "#fff" } : { color: this.props.fontColor || "#b1b1b1" }]}>
